...
public class OriginalTest {
	public static void main(String[] args) {
		...
		double[] rainfallRange_wm2 = { 0.0, 0.122649, 3.321, 14.333, 34.1386,
				156.7519884 };
		double[] rainfallRange_w1 = { 0.0, 0.122649, 3.321, 14.333, 34.1386,
				156.7519884 };

		double[] lstRange_w0 = { 0.0, 24.6, 26.6, 28.3, 31.43, 39 };
		double[] lstRange_w1 = { 0.0, 24.6, 26.6, 28.3, 31.43, 39 };
		double[] lstRange_w2 = { 0.0, 24.6, 26.6, 28.3, 31.43, 39 };
		...
		double[] ndviRange_w0 = { 0.0, 0.62, 0.71, 0.77, 0.83,
				0.9300000000000001 };
		double[] ndviRange_w1 = { 0.0, 0.62, 0.71, 0.77, 0.83,
				0.9300000000000001 };
		double[] ndviRange_w2 = { 0.0, 0.62, 0.71, 0.77, 0.83,
				0.9300000000000001 };

		// best bin
		// double[] arima_w1_range = {0.0, 14.1661, 28.33, 42.4983, 56.66,
		// 70.8305, 200};
		// double[] arima_w1_range = {0, 0.5, 1.5, 2.5, 5.5, 6.5, 7.5, 8.5, 9.5,
		// 10.5, 11.5, 13, 16.5, 82.09999999999999};
		// double[] arima_w2_range = {0, 0.5, 1.5, 2.5, 5.5, 6.5, 7.5, 8.5, 9.5,
		// 10.5, 11.5, 13, 16.5, 82.09999999999999};
		double[] arima_w1_range = { 0.0, 15.98, 31.96, 47.94, 63.929, 200 };
		double[] arima_w2_range = { 0.0, 15.98, 31.96, 47.94, 63.929, 200 };
		// arima_3_equal
		// double[] arima_w1_range = {0.0, 1.723, 5.276, 100};
		// arima_5_equal
		// double[] arima_w1_range = {0.0, 0.789, 2.355, 4.30, 8.4339, 100};
		// arima_3_inequal
		// double[] arima_w1_range = {0.0, 26.56, 53.123, 100};
		// arima_5_inequal
		// best with arima
		// double[] arima_w1_range = {0.0, 15.93, 31.874, 47.811, 63.74, 100};
		// double[] arima_w1_range = {0.0, 15.93, 31.874, 63.74, 100};
		// arima_6_inequal
		// double[] arima_w1_range = {0.0, 13.28, 26.56, 39.84, 53.123, 100};

		double[] incidents_rate_w1_range = { 0.0, 0.006098, 0.030488, 1 };
		// double[] incidents_rate_w1_range = {0.0, 0.006098, 0.018293,
		// 0.054878, 1};
		// double[] incidents_rate_w1_range = {0.0, 0.25, 0.5, 0.75, 1};
			...
			try {
				...
				while ((line = br.readLine()) != null) {
					if (i != 0) {
						...
						// int malaria_1_state =
						// DoInference.getGlobalState(Double.valueOf(dataWithNoSeparator[13]),
						// malaria_w1);
						int month_2_state = Integer
								.valueOf(dataWithNoSeparator[16]) - 1;
						// int malaria_2_state =
						// DoInference.getGlobalState(Double.valueOf(dataWithNoSeparator[28]),
						// malaria_w2);
						// int month_3_state =
						// Integer.valueOf(dataWithNoSeparator[29])-1;
						// int malaria_3_state =
						// DoInference.getGlobalState(Double.valueOf(dataWithNoSeparator[33]),
						// malaria_w3);
						...
						int rainfallwm2_state = getGlobalState(
								...
								rainfallRange_wm2);
						// int incidence_wm1_state =
						// getGlobalState(Double.valueOf(dataWithNoSeparator[55]),
						// incidents_wm1);
						// int nearest_sum_w0_state =
						// getGlobalState(Double.valueOf(dataWithNoSeparator[21]),
						// nearest_sum_w0_range);
						int arima_w1_state = getGlobalState(
								Double.valueOf(dataWithNoSeparator[23]),
								arima_w1_range);
						int arima_w2_state = getGlobalState(
								Double.valueOf(dataWithNoSeparator[24]),
								arima_w2_range);

						int incidents_rate_state = getGlobalState(
								Double.valueOf(dataWithNoSeparator[25]),
								incidents_rate_w1_range);
						...
						// double malaria_3_actual =
						// Double.valueOf(dataWithNoSeparator[38]);
						...
						// Restricting Entering evidence for Malaria Nodes
						...
						// incidence_wm1.finding().enterState(incidence_wm1_state);
						// Month_w3.finding().enterState(month_3_state);
						// rainfall_wm1.finding().enterState(rainfallwm1_state);
						// arima_w1.finding().enterState(arima_w1_state);
						// incidents_rate_w1.finding().enterState(
						// incidents_rate_state);
						...
						System.out.println(expected_w2);
						//
						// double expected_w3 = 0.0;
						// expected_w3 = getExpectedValue(Malaria_w3,
						// malaria_w3);
						...
						// malaria_w3);
						// confMat_w3[actualState_w3][predictedState_w3] =
						// confMat_w3[actualState_w3][predictedState_w3] + 1;
				...
				// printConfusionMatrix(confMat_w3, Malaria_w3);
				// System.out.println("Absolute Error: "+absoluteError_w3);
				// System.out.println("Mean Absolute Error: "+(absoluteError_w3/(i-1)));
				// System.out.println("Error Rate: "+getErrorRate(confMat_w3,
				// i-1));
	...
	public static double[] getMidpoints(double[] binRanges) {
		...
		// 0.0, 0.98, 1.5, 2.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 13, 16.5,
		// 30, 82.09999999999999
		double[] midPoints = { 0.0, 1.0, 2.0, 3.79, 6.0, 7.0, 8.0, 9.0, 10.0,
				11.0, 12.32, 14.85, 21.93, 43.57 };
		// double[] midPoints = {0.0, 1.0, 2.0, 3.79, 6.0, 7.0, 8.0, 9.0, 10.0,
		// 11.0, 12.32, 14.85, 21.93, 36.62, 60.69};
